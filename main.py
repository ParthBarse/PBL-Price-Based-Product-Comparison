try:
    ...
    print("Cannot import 1st modules !")
try:
    from bs4 import BeautifulSoup as bs
except:
    print("Cannot import 2nd modules !")
try:
    from flask import Flask, render_template, request
except:
    print("Cannot import 3rd modules !")
try:
    import requests
except:
    print("Cannot import 4th modules !")
try:
    import random
except:
    print("Cannot import some modules !")
